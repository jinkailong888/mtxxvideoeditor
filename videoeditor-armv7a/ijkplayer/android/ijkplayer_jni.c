...
static void
IjkMediaPlayer_setWatermark(JNIEnv *env, jobject thiz, jstring imgPath,
    ...
    JNI_CHECK_GOTO(mp, env, "java/lang/IllegalStateException", "mpjni: save: null mp",
                   LABEL_RETURN);
    JNI_CHECK_GOTO(imgPath, env, "java/lang/IllegalArgumentException",
                   "mpjni: save: null imgPath", LABEL_RETURN);
    const char *path = (*env)->GetStringUTFChars(env, imgPath, NULL);
    ijkmp_setWatermark(mp, path, width, height, startTime, duration, pos, horizontalPadding,
                       verticalPadding);
    LABEL_RETURN:
    ijkmp_dec_ref_p(&mp);
}
...
IjkMediaPlayer_showWatermark(JNIEnv *env, jobject thiz) {
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    JNI_CHECK_GOTO(mp, env, "java/lang/IllegalStateException", "mpjni: showWatermark: null mp",
                   LABEL_RETURN);
...
IjkMediaPlayer_hideWatermark(JNIEnv *env, jobject thiz) {
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    JNI_CHECK_GOTO(mp, env, "java/lang/IllegalStateException", "mpjni: hideWatermark: null mp",
                   LABEL_RETURN);
...
static void
IjkMediaPlayer_clearWaterMark(JNIEnv *env, jobject thiz) {
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    JNI_CHECK_GOTO(mp, env, "java/lang/IllegalStateException", "mpjni: clearWaterMark: null mp",
                   LABEL_RETURN);

    ijkmp_clearWatermark(mp);
...
static void
IjkMediaPlayer_setBgMusic(JNIEnv *env, jobject thiz,
                          jstring musicPath,
                          jint startTime,
                          jint duration,
                          jfloat speed,
                          jboolean loop) {
    IjkMediaPlayer *mp = jni_get_media_player(env, thiz);
    JNI_CHECK_GOTO(mp, env, "java/lang/IllegalStateException", "mpjni: setBgMusic: null mp",
                   LABEL_RETURN);
...
static JNINativeMethod g_methods[] = {
        ...
        {       "setWatermark",          "(Ljava/lang/String;IIIIIII)V",                           (void *) IjkMediaPlayer_setWatermark},
        {       "showWatermark",         "()V",                                                    (void *) IjkMediaPlayer_showWatermark},
        {       "hideWatermark",         "()V",                                                    (void *) IjkMediaPlayer_hideWatermark},
        {       "clearWaterMark",        "()V",                                                    (void *) IjkMediaPlayer_clearWaterMark},

...
FFPlayer *ffp_create(jboolean b, jboolean i);
...
#define WATERMARK_POS_CENTER  0
#define WATERMARK_POS_TOP_LEFT  1
#define WATERMARK_POS_TOP_RIGHT  2
#define WATERMARK_POS_BOTTOM_RIGHT  3
#define WATERMARK_POS_BOTTOM_LEFT  4
#define WATERMARK_VIDEO_DURATION  -1

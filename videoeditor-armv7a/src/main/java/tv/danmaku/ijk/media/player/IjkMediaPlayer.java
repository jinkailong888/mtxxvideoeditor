...
//        Surface surface1 = new MySurface(new SurfaceTexture(0),100,200);
    ...
    public native void setWatermark(String imgPath,
                                    int width, int height,
                                    int startTime, int duration,
                                    int pos,
                                    int horizontalPadding,
                                    int verticalPadding) throws IllegalStateException;

    public native void showWatermark() throws IllegalStateException;

    public native void hideWatermark() throws IllegalStateException;

    public native void clearWaterMark() throws IllegalStateException;

    public native void setBgMusic(String musicPath,
                                  int startTime,
                                  int duration,
                                  float speed,
                                  boolean loop) throws IllegalStateException;

...
import com.meitu.library.videoeditor.save.video.gl.basis.MTGLRender;
...
public class CodecOutputSurface
    ...
    private final static String TAG = Tag.build("CodecOutputSurface");
    ...
    public boolean swapBuffers() {
        //采用双缓冲技术，交换display和surface，这样display就能看到后台surface绘制的内容了
        //将数据送给FrameBuffer显示
    ...
    public void saveBitmap(){
        mTextureRender.saveBitmap(mWidth,mHeight);
    }
